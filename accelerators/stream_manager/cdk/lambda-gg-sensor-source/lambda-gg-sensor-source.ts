...
export class GreengrassLambdaSensorSource extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, props: GreengrassLambdaSensorSourceProps) {
    super(scope, id);
    // Create and Deploy Lambda for use by Greengrass
    const greengrassLambda = new lambda.Function(this, props.stackName + '-SensorSource', {
