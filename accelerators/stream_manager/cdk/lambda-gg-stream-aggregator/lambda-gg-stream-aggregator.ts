...
export class GreengrassLambdaStreamAggregator extends cdk.Construct {
  ...
  constructor(scope: cdk.Construct, id: string, props: GreengrassLambdaStreamAggregatorProps) {
    super(scope, id);
    // Create and Deploy Lambda for use by Greengrass
    const greengrassLambda = new lambda.Function(this, props.stackName + '-StreamAggregator', {
