...
def obd2_convert(msg):
    ...
    timestamp = float(msg.decode().split(" ")[0])
    arbitration_id = msg.decode().split(" ")[1]
    event = bytearray.fromhex(msg.decode().split(" ")[2])
