...
export class IotThingGroup extends Construct {
  ...
  constructor(scope: Construct, id: string, props: IotThingGroupProps) {
    ...
    const thingGroupDescription =
      props.thingGroupDescription || "CloudFormation generated group"

    const provider = IotThingGroup.getOrCreateProvider(
      this,
      ...
      new iam.PolicyStatement({
        ...
        resources: [
          `arn:${cdk.Fn.ref("AWS::Partition")}:iot:${cdk.Fn.ref(
            "AWS::Region"
          )}:${cdk.Fn.ref("AWS::AccountId")}:thinggroup/${
